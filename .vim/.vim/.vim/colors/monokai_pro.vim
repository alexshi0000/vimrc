...
hi LineNr ctermfg=239 ctermbg=234 cterm=NONE guibg=#262626 guifg=#878787 guisp=NONE gui=NONE
...
hi Folded ctermfg=242 ctermbg=234 cterm=NONE guibg=#262626 guifg=#666666 guisp=NONE gui=NONE
...
hi DiffAdd ctermfg=231 ctermbg=156 cterm=bold guibg=#aadb7b guifg=#ffffff guisp=NONE gui=bold
...
hi Identifier ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
...
hi PreProc ctermfg=204 ctermbg=NONE cterm=NONE guibg=NONE guifg=#aadb7b guisp=NONE gui=NONE
hi Special ctermfg=247 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
...
hi StorageClass ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
...
hi Type ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
...
hi rubyFunction ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#aadb7b guisp=NONE gui=NONE
...
hi rubyConstant ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
...
hi rubyRailsUserClass ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
hi rubyRailsARAssociationMethod ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
hi rubyRailsARMethod ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
hi rubyRailsRenderMethod ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
hi rubyRailsMethod ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
...
hi erubyRailsMethod ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
...
hi htmlArg ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
hi htmlSpecialChar ctermfg=141 ctermbg=NONE cterm=NONE guibg=NONE guifg=#ab9ff0 guisp=NONE gui=NONE
hi javaScriptFunction ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
hi javaScriptRailsFunction ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
...
hi cssFunctionName ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
hi cssColor ctermfg=141 ctermbg=NONE cterm=NONE guibg=NONE guifg=#ab9ff0 guisp=NONE gui=NONE
hi cssPseudoClassId ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#aadb7b guisp=NONE gui=NONE
hi cssClassName ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#aadb7b guisp=NONE gui=NONE
hi cssValueLength ctermfg=141 ctermbg=NONE cterm=NONE guibg=NONE guifg=#ab9ff0 guisp=NONE gui=NONE
hi cssCommonAttr ctermfg=156 ctermbg=NONE cterm=NONE guibg=NONE guifg=#7cdce7 guisp=NONE gui=NONE
