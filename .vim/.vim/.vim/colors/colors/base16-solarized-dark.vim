...
call <sid>hi("VertSplit",     s:gui02, s:gui02, s:cterm05, s:cterm0F, "none", "")
...
" =====> user defined highlighting options
"hi cursorline ctermfg=none ctermbg=none
"hi LineNR ctermbg=black
"hi cursorlinenr ctermbg=black these don't exist for now

hi TabLineFill ctermfg=23 ctermbg=23
hi TabLine ctermfg=gray ctermbg=23 cterm=none
hi TabLineSel ctermfg=white ctermbg=23  cterm=none

hi PmenuSel cterm=none ctermbg=green ctermfg=black
hi Pmenu cterm=none    ctermbg=black ctermfg=gray

"hi VertSplit ctermfg=23 ctermbg=black
hi StatuslineNC ctermfg=23 ctermbg=23
hi StatusLine ctermfg=none ctermbg=23

hi TODO ctermfg=yellow ctermbg=black
hi ExtraWhitespace ctermfg=yellow ctermbg=none cterm=underline
